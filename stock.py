...
prev_start_date = "2021-02-23"
prev_end_date = "2021-02-24"
...
def stock_percentage(prev_start_date, prev_end_date, start_date, end_date, stock_name):
    yfinance.download(stock_name, start=prev_start_date, end=prev_end_date).to_csv("prev" + stock_name + ".csv")
...
def main():
    for stock_name in stock_name_list:
        stock_percentage(prev_start_date, prev_end_date, start_date, end_date, str(stock_name[0]))
